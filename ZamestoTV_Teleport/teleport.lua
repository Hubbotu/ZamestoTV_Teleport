...
local G = {
    MapTeleports = {
        ...
        { spellID = 1254572, mapID = 558, name = "Magisters' Terrace" },	
        { spellID = 1254559, mapID = 560, name = "Maisara Caverns" },	
        { spellID = 1254563, mapID = 559, name = "Nexus-Point Xenas" },	
        { spellID = 1254400, mapID = 557, name = "Windrunner Spire" },	
        { spellID = 1254551, mapID = 583, name = "The Seat of the Triumvirate" },
        { spellID = 1254551, mapID = 239, name = "The Seat of the Triumvirate" },			
        { spellID = 1254555, mapID = 556, name = "Pit of Saron" },	
        { spellID = 1254557, mapID = 161, name = "Skyreach" },
        { spellID = 1286812, mapID = 588, name = "Altar of Fangs" },		
        { spellID = 1286809, mapID = 587, name = "Murder Row" },		
        { spellID = 1286807, mapID = 586, name = "Den of Nalorakk" },		
        { spellID = 1286801, mapID = 584, name = "The Blinding Vale" },		
        { spellID = 1286804, mapID = 585, name = "Voidscar Arena" },		
        { spellID = 1286828, mapID = 250, name = "Temple of Sethraliss" },	
        { spellID = 1286831, mapID = 249, name = "Kings' Rest" },			
    },
